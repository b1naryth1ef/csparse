...
_CNETMSG_PLAYERAVATARDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rgb', full_name='CNETMsg_PlayerAvatarData.rgb', index=1,
...
_CCLCMSG_VOICEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sequence_bytes', full_name='CCLCMsg_VoiceData.sequence_bytes', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='section_number', full_name='CCLCMsg_VoiceData.section_number', index=4,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='uncompressed_sample_offset', full_name='CCLCMsg_VoiceData.uncompressed_sample_offset', index=5,
      number=6, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CSVCMSG_VOICEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='format', full_name='CSVCMsg_VoiceData.format', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sequence_bytes', full_name='CSVCMsg_VoiceData.sequence_bytes', index=7,
      number=8, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='section_number', full_name='CSVCMsg_VoiceData.section_number', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='uncompressed_sample_offset', full_name='CSVCMsg_VoiceData.uncompressed_sample_offset', index=9,
...
DESCRIPTOR.message_types_by_name['CNETMsg_PlayerAvatarData'] = _CNETMSG_PLAYERAVATARDATA
...
class CNETMsg_PlayerAvatarData(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _CNETMSG_PLAYERAVATARDATA
...
_ESPLITSCREENMESSAGETYPE.has_options = True
_ESPLITSCREENMESSAGETYPE._options = _descriptor._ParseOptions(descriptor_pb2.EnumOptions(), '\020\001')
